...
export default function Loading() {
  return (
    <AppShell activeSidebarKey="search">
      <main className="px-17-5 pt-top pb-12-5">
        {/* 1. Judul "Eksplor topik" skeleton */}
        <div className="mb-7-25 h-9 w-48 animate-pulse rounded-md bg-card-border/40" />
