...
import { Menu, ThumbsUp, Share2, Flag, Search, ArrowLeft, ArrowRight, Bell } from 'lucide-react';

const iconOptions = ['Menu', 'Like', 'Share', 'Flag', 'Search', 'Bell', 'ArrowLeft', 'ArrowRight'] as const;
