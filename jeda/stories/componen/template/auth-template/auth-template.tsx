...
import { LoginModal, LoginModalProps } from "../../organism/auth/login-modal/login-modal";
import { RegisterModal, RegisterModalProps } from "../../organism/auth/register-modal/register-modal";
import { ForgotPasswordModal } from "../../organism/auth/forgot-password-modal/forgot-password-modal";
import {
  OtpVerificationModal,
  OtpVerificationModalProps,
} from "../../organism/auth/otp-verification-modal/otp-verification-modal";
import { CreateNewPasswordModal } from "../../organism/auth/create-new-password-modal/create-new-password-modal";
import { CategorySelectionModal } from "../../organism/auth/category-selection-modal/category-selection-modal";
import { TermsModal, TermsModalProps } from "../../organism/auth/terms-modal/terms-modal";
import { BecomeAuthorModal } from "../../organism/auth/become-author-moda/become-author-modal";
