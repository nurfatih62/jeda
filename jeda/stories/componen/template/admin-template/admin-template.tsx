...
import { AdminLayout, AdminLayoutProps } from "../../organism/admin/admin-layout/admin-layout";
import { AdminDashboard, AdminDashboardProps } from "../../organism/admin/admin-dashboard/admin-dashboard";
import { AdminLaporan, AdminLaporanProps } from "../../organism/admin/admin-laporan/admin-laporan";
import { ManajemenPengguna, ManajemenPenggunaProps } from "../../organism/admin/manajemen-pengguna/manajemen-pengguna";
import { CategoryManagementSection, CategoryManagementSectionProps } from "../../organism/admin/CategoryManagementSection/CategoryManagementSection";
import { UserProfileSection, UserProfileSectionProps } from "../../organism/admin/UserProfileSection/UserProfileSection";
