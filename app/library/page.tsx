  ...
  return (
    <AppShell activeSidebarKey="library">
      ...
      <div className="flex flex-col w-full max-w-page px-xs py-sm gap-banner">
            ...
            <div className="flex flex-row items-center gap-gap-lg overflow-x-auto scrollbar-hide w-full">
              {FILTER_TABS.map((filterName, index) => {
                ...
                return (
                  ...
                  >
                    <span className="font-sans font-medium text-btn leading-[24px] text-center">
                      {filterName}
                    </span>
                  </Link>
                );
        ...
        <div className="flex flex-col items-center pt-top pb-0 gap-3 max-w-card w-full opacity-80">
          ...
          <div className="flex flex-col items-start gap-gap-lg max-w-content w-full">
            ...
            <p className="font-sans font-medium text-desc leading-[28px] text-center w-full text-text-muted">
          ...
          <div className="flex flex-row justify-center items-center gap-3 w-card-img-mobile-h h-17-5">
            ...
            <div className="flex flex-row items-center">
              <button 
                className="flex flex-row justify-center items-center h-[40px] border border-primary-border rounded-sm bg-transparent cursor-pointer hover:bg-primary-overlay-hover transition-all"
            ...
            <button 
              className="flex flex-row justify-center items-center h-[40px] bg-primary rounded-sm border-none cursor-pointer hover:bg-primary-hover transition-all shadow-sm"
